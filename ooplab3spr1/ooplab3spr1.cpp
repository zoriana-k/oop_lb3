...
void processProject(const project& p) {
    std::cout << "Processing project: " << p.name << std::endl;
    std::cout << "Customer: " << p.customer << std::endl;
    std::cout << "Budget: " << p.budget << std::endl;
...
void processProjectPointer(const project* p) {
    std::cout << "Processing project by pointer: " << p->name << std::endl;
    std::cout << "Customer: " << p->customer << std::endl;
    std::cout << "Budget: " << p->budget << std::endl;
...
int main() {
    std::cout << "Demonstrating all constructors of manager class:\n";
    ...
    std::cout << "Dynamic project budget: " << dynamicProject->budget << std::endl;
